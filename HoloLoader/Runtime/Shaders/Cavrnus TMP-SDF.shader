...
// BEGIN from TMPRO-Properties.cginc:
...
#define fixed4 float4
                ...
                pixel_t VertShader(vertex_t input)
                {
                   ...
                   // UNITY_INITIALIZE_OUTPUT(pixel_t, output);
                    ...
                    VertexPositionInputs vertexInput = GetVertexPositionInputs(vert.xyz);


                    float4 vPosition = vertexInput.positionCS;
                ...
                float4 PixShader(pixel_t input) : SV_Target
                {
                    ...
                    float4 reflcol = texCUBE(_Cube, reflect(input.viewDir, -n));
